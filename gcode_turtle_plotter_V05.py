...
#file1 = open("cyrillic/ltr_И.txt", "r")
#file1 = open("cyrillic/ltr_Ё.txt", "r")
#file1 = open("cyrillic/ltr_Д.txt", "r")
#file1 = open("cyrillic/chars/char_!.txt", "r")
#file1 = open("cyrillic/ltr_О.txt", "r")
#file1 = open("ltr_A.txt", "r", encoding='utf-8')
#file1 = open("roman/ltr_Ü.txt", "r", encoding='utf-8')
file1 = open("user_texts/greet.txt", "r", encoding='utf-8')
#file1 = open("roman/chars/char_@.txt", "r", encoding='utf-8')
#file1 = open("user_texts/trial7.txt", "r", encoding='utf-8')
...
for line in Lines:
    ...
    if lList[0] == 'G0':
        ...
        try:
            ...
            print("exception, y1-yc=0 means division by 0")
            if lList[0] == 'G3':
                if y1-y2>0:
                    startheading = 180 #point straight down
                elif y1-y2<0:
                    startheading = 0   #point straight up
            if lList[0] == 'G2':
                if y1-y2>0:
                    startheading = 0 #point straight down
                elif y1-y2==0:
                    if x1-x2>0:
                        startheading = 0 #point straight down
                    else:
                        startheading = 180   #point straight up
                elif y1-y2<0:
                    startheading = 180   #point straight up
                

        # mode "logo" being used!
