...
Formatting = 'r'   # c or r (cycrillic or roman) (will be automised)
...
UserText = 'I wish everyone at Qwello a nice weekend!!'
UserText = 'In Mecklenburg-Vorpommern haben die Behörden binnen 24 Stunden 1.934 neue Corona-Infektionen registriert. Das sind 178 Fälle weniger als vor einer Woche, wie das Landesamt für Gesundheit und Soziales in Rostock heute mitteilte. Die Zahl der Todesfälle seit Beginn der Pandemie stieg demnach um 2 auf 2.360. Landesweit werden 28 Covid-19-Patienten auf Intensivstationen behandelt. Die Hospitalisierungsinzidenz liegt den Angaben zufolge bei 5,0.'
UserText = 'Finanzmarktstabilisierungsfonds-Verordnung in der am 23. Juli 2009 geltenden Fassung gelten für die Garantiegewährung nach Absatz 1 entsprechend. 5 Absatz 2 Nummer 5 der Finanzmarktstabilisierungsfonds-Verordnung findet jedoch vorbehaltlich der Zahlung der Ausgleichsbeträge nach den 6b und 6c auf Dividenden und Gewinnausschüttungen an die Anteilseigner keine Anwendung'
SaveName= "greet3.txt" # where to save it 
